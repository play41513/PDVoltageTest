...
private:
	...
	bool ReadEMarkValue();
	void calculateEMarkValue();
	AnsiString hexToBinary(AnsiString hexString);
...
public:
	...
	queue<UI_UPDATE_DESCRIPOR> queUIUpdate;
	void AddToUIUpdateQueue(DWORD msg, DWORD wParam, DWORD lParam);
};
//---------------------------------------------------------------------------
#endif
